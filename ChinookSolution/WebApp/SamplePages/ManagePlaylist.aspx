...
<div>
    ...
    <div class="row">
    <div class="col-sm-2">
        <asp:Label ID="Label1" runat="server" Text="Artist" Font-Bold="true" Font-Size="Larger" ></asp:Label><br />
        <asp:TextBox ID="ArtistName" runat="server"
            CssClass="form-control" placeholder="artist name">
        </asp:TextBox><br />
        ...
        <asp:DropDownList ID="MediaTypeDDL" runat="server"
            ...
            AutoPostBack="true" 
            AppendDataBoundItems="true" OnSelectedIndexChanged="MediaTypeDDL_SelectedIndexChanged">
        ...
        <asp:TextBox ID="AlbumTitle" runat="server" ToolTip="Enter a partial album title"
    ...
    <asp:ObjectDataSource ID="TracksSelectionListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="List_TracksForPlaylistSelection" TypeName="ChinookSystem.BLL.TrackController" 
        OnSelected="CheckForException">
        <SelectParameters>
            <asp:ControlParameter ControlID="TracksBy" PropertyName="Text" DefaultValue="asdeasd" Name="tracksby" Type="String"></asp:ControlParameter>
            <asp:ControlParameter ControlID="SearchArg" PropertyName="Text" DefaultValue="mdidbvf" Name="arg" Type="String"></asp:ControlParameter>
        </SelectParameters>
    </asp:ObjectDataSource>
