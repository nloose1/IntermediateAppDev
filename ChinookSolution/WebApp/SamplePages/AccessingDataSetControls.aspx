...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <asp:Panel ID="ControlPanel" runat="server">
            ...
            <br /><br />
            <asp:GridView ID="TrackListGV" runat="server" AutoGenerateColumns="False" DataSourceID="TracksDataODS" OnSelectedIndexChanged="TrackListGV_SelectedIndexChanged" GridLines="Both" BorderStyle="None">
                <Columns>
